...
class MediaPlayerService : Service() {
    ...
    override fun onCreate() {
        ...
        val mainPendingIntent = PendingIntent.getActivity(baseContext, 0, Intent(baseContext, MainActivity::class.java)
            .apply {
        ...
        val notification = Notification.Builder(baseContext, CHANNERL_ID )
            .setStyle(
